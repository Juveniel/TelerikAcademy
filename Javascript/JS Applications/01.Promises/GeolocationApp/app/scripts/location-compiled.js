...
LC.currentLocation = function () {
    ...
    var ERROR_TYPE_CODES = ['Unknown error', 'Permission denied by user', 'Position is not available', 'Request timed out'];
    ...
    var getLocation = function getLocation() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            // Geolocation API
            navigator.geolocation.getCurrentPosition(function resolveLocation(position) {
